...
git remote set-url origin https://REMOVED_TOKEN@github.com/prashanthkatam/ltibloodbank.git

git remote set-url origin https://REMOVED_TOKEN@github.com/prashanthkatam/Hackathon.git
